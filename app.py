...
with col_a:
    ...
    if ff_file:
        try:
            ...
            # DEBUG temporal
            sub_status = f"OK ({ff_sub_key[:6]}...)" if ff_sub_key else "FALTA"
            st.caption(f"DEBUG — email: {'OK' if ff_email else 'FALTA'} | password: {'OK' if ff_password else 'FALTA'} | sub_key: {sub_status}")
